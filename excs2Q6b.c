...
int main()
{
    ...
    scanf("%d",&kw);
    if(U=='C')//if U inputed is C then to execute the following
    {
          if(kw>1000)
        {
           x=50000;
    ...
    else if(U=='I')//if U inputed is I to execute the following.
        {
        while (T==1)
        printf("\n\t USER MENU");
        printf("\n\t1.Peak");
        printf("\n\t2.Off_peak");
        printf("\n\n\nEnter your time of usage:");
        scanf("%1[12]d%*c",&T);
